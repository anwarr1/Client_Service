...
public class AgentController {
    ...
    public AgentController(AgentService agentService, AdminService adminService, ClientService clientService,RestTemplate restTemplate,UserService userService,AuthenticationService service) {
