...
import org.example.client_service.security.JwtService;
import org.example.client_service.token.Token;
import org.example.client_service.token.TokenRepository;
import org.example.client_service.token.TokenType;
...
//            buildEmail(request.getPrenom(), link));
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        try {
            System.out.println("AUTHENTIFICATE SERVICE");
            ...
            e.printStackTrace();
            throw e; // Or handle the exception as per your application's requirement
        }
    }
